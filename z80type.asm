...
; A>Z80TYPE
;
; Modified for Z80-MBC2 with BIOS-Mod by SvenMb 
...
OPCODE		EQU	01H				; IOS opcode write port address
WPORT		EQU	00H				; IOS "execute opcode" write port address
RPORT		EQU	00H				; IOS "execute opcode" write port address
...
; 2. CHECK THE VALUE READ BACK IN STEP 4
;      0 - NMOS CPU
;      0FFH - CMOS CPU
	MVI	A,07EH
	OUT OPCODE
